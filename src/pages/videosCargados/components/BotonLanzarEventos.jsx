...
export default function BotonLanzarEventos({uid}) {
  ...
  return (
   ...
   className='h-10 w-9/12 flex items-center text-sm font-bold px-5 text-gray-600 bg-paleta1-secondary rounded justify-between hover:bg-neutral-500/80 duration-300 hover:text-paleta1-secondary group'>
    Lanzar evento
