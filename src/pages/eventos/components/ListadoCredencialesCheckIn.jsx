...
export default function ListadoCredencialesCheckIn({ uid }) {
  return (
    <div className="bg-white rounded-lg w-full min-h-[50vh]  text-paleta1-gray p-4">
      ...
      <div className="w-full h-10 my-10 bg-white/50  cursor-pointer backdrop-blur-sm  rounded border-2 border-gray-500/50 flex items-center relative">
        <div className="bg-blue-400/70 backdrop-blur-sm w-1/3 absolute group top-0 left-0 h-full ">
        ...
        <div className="bg-red-400/70 backdrop-blur-sm group w-2/3 absolute top-0 right-0 h-full  border-l-2 border-white/80 ">
